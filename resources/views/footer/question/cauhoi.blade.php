...
<div style="margin-top:20px;max-width:1280px; grid-template-columns: repeat(3, 1fr)" class=" e gap-5 grid grid-cols-3">
        <div>
            <p>Châu lục</p>
    ...
    <div style="margin-bottom: 10px;margin-top:20px;max-width:1280px" class=" gap-5 grid grid-cols-2">
        <div>
            <div>
                <input style="border-radius: 5px; width: 400px " class="border h-8" type="text" placeholder="     Tên công ty*">
            </div>
        </div>
        <div>
    ...
    <div>
        <div style="width: 99%;" class=" h-28">
            <textarea style="width:100%; height:90%; border-width:1px; padding-top:10px"  name="" id="" placeholder="   Hãy cho chúng tôi biết về bạn/doanh nghiệp của bạn"></textarea>
        </div>
    </div>
    <div>
        <div style="width: 99%;" class=" h-28">
            <textarea style="width:100%; height:90%; border-width:1px; padding-top:10px"  name="" id="" placeholder="   Nhập nội dung cần hỏi"></textarea>
        </div>
    </div>
